...
[![NPM](https://nodei.co/npm/@trrxitte/traaittcash-crypto.png?downloads=true&stars=true)](https://nodei.co/npm/@trrxitte/traaittcash-crypto/)

#### Master Build Status
[![Build Status](https://travis-ci.org/traaitt/traaittcash-crypto.svg?branch=master)](https://travis-ci.org/traaitt/traaittcash-crypto) [![Build status](https://ci.appveyor.com/api/projects/status/github/traaitt/traaittcash-crypto?branch=master&svg=true)](https://ci.appveyor.com/project/brandonlehmann/traaittcash-crypto)

# traaittCASH: Standalone Cryptography Library

This repository contains the necessary files to compile the cryptography library used within [traaittCASH](https://traaittCASH.com) as a standalone library that can be included in various other projects in a variety of development environments, including:
...
```bash
npm install traaittcash-crypto
```

### Intialization

```javascript
const traaittCASHCrypto = require('traaittcash-crypto')
```
...
git clone -b master --single-branch https://github.com/trrxitte/traaittcash-crypto
cd traaittcash-crypto
mkdir build
cd build
cmake ..
make -j
...
The static library will be built as `libtraaittcash-crypto.a` in the build folder.
...
* `libtraaittcash-crypto-static.a`
...
```
cd <your_traaittcash-crypto_directory>
mkdir build
cd build
...
`MSBuild traaittcash-crypto.sln /p:Configuration=Release /m`

The following library files will be created in the `build/Release` folder:

* `traaittcash-crypto-static.lib`
* `traaittcash-crypto-shared.lib`
* `traaittcash-crypto-shared.dll`
...
* Native Javascript
  * `traaittcash-crypto.js`
* WASM
  * `traaittcash-crypto-wasm.js`
