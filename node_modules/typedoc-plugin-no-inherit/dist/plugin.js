...
class NoInheritPlugin {
     ...
     */
    initialize(app) {
        app.converter.on(typedoc_1.Converter.EVENT_BEGIN, this.onBegin.bind(this));
        app.converter.on(typedoc_1.Converter.EVENT_CREATE_DECLARATION, this.onDeclaration.bind(this), null, -1100); // after ImplementsPlugin
        app.converter.on(typedoc_1.Converter.EVENT_RESOLVE_BEGIN, this.onBeginResolve.bind(this));
    ...
    onDeclaration(context, reflection, node) {
        if (reflection instanceof typedoc_1.DeclarationReflection) {
            ...
            if (reflection.kindOf(typedoc_1.ReflectionKind.ClassOrInterface) &&
            ...
            if (reflection.inheritedFrom && reflection.parent && reflection.parent.kindOf(typedoc_1.ReflectionKind.ClassOrInterface) &&
    ...
    isNoInheritRecursive(context, current, depth) {
        ...
        const checkExtended = (type) => {
            ...
            if (extended instanceof typedoc_1.Reflection) {
